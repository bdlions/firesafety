            ...
            <div class="container">
				...
				<form action="contact-us.php" method="post">
					...
					<div class="row form-group">
						...
						<div class="col-xs-12 col-sm-8 col-md-4 col-lg-4">
							<textarea rows="5" class="form-control wow fadeInRightBig fade-timer-4th" name="message"></textarea>
						</div>
					</div>
					<div class="row form-group">
						<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
							<button name="send_message" type="submit" class="custom-button pull-right wow fadeInRightBig fade-timer-5th">Send</button>
						</div>
					</div>
				</form>
            </div>
